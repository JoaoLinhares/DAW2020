            ...
            <html>
                ...
                <body style="background-color: teal;">
                    ...
                    <div class="w3-row" style="margin-top: 5%; margin-right:10%; margin-left:10%; text-align: center;">
                            ...
                            <address class="simpletext">
                                <xsl:choose>
                                    <xsl:when test="position() - 1 = 0">
                                        [<a href="/arqs/{count(//ARQELEM)}">Anterior</a>]
                                    </xsl:when>
                                    <xsl:otherwise>
                                        [<a href="/arqs/{position() - 1}">Anterior</a>]
                                    </xsl:otherwise>
                                </xsl:choose>
                            </address>
                        </div>
                        <div class="w3-third w3-container">
                            <address class="simpletext">
                                [<a href="/index.html#arqs={position()}">Voltar ao Índice</a>]
                            </address>
                        </div>
                        <div class="w3-third w3-container">
                            <address class="simpletext">
                                <xsl:choose>
                                    <xsl:when test="position() + 1 > count(//ARQELEM)">
                                        [<a href="/arqs/1">Próximo</a>]
                                    </xsl:when>
                                    <xsl:otherwise>
                                        [<a href="/arqs/{position() + 1}">Próximo</a>]
                                    </xsl:otherwise>
                                </xsl:choose>
                            </address>
                        </div>
