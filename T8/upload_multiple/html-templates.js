...
function fileList( files, d){
    ...
    pagHTML += `
          ...
          <div style="text-align:center; margin:1%">
            <button onclick="window.location.href='/files/upload'" style="text-align:center;"> Upload Files </button>
          </div>  
        <div class="w3-container w3-teal">
              <address>Generated by upload-multiple::DAW2020 em ${d} --------------</address>
          </div>
      </body>
      </html>
    `
    ...
    <html>
        ...
        <body>
            ...
            <form class="w3-container" action="/files" method="POST" enctype="multipart/form-data">
                ...
                <div id="addFile" class="1"></div>

                <input type="button" onclick='addFileToForm();' class="w3-btn w3-green" value="Add another file"/>
                
                <input class="w3-btn w3-blue-grey" type="submit" value="Submit"/>
            </form>
            <div style="text-align:center; margin:1%">
            <button onclick="window.location.href='/'" style="text-align:center;"> Go Back to Main Page </button>
          </div> 
            <footer class="w3-container w3-teal">
                <address>Gerado por upload-multiple::DAW2020 em ${d}</address>
            </footer>
        </body>
    </html>
    `
